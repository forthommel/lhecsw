...
//-------------------------------------------------------------------------------------------------
{
  ...
  float SolenoidBarrelConductorInnerRadius1 =
  ...
  cout << " -----------------number of readout channels for lowE_Fhe det. = " << number_of_reaout_channel
       << endl;  //number of readout channel
  ...
  for (int i = 0; i != NbOfELayers1; ++i) {
    scint_area1 =
        (EcalBarrel_zmax * (2 * 3.14159 * (EfirstLength + Pb_thickness1 + Polys_thickness + i * ESpacing1))) / 1e4;
  ...
  for (int i = 0; i != NbOfELayers2; ++i) {
    scint_area2 =
        (EcalBarrel_zmax *
         (2 * 3.14159 * (EfirstLength + FirstEcalvolume_length + Pb_thickness2 + Polys_thickness + i * ESpacing2))) /
        1e4;
  ...
  for (int i = 0; i != NbOfELayers3; ++i) {
    scint_area3 = (EcalBarrel_zmax * (2 * 3.14159 *
                                      (EfirstLength + FirstEcalvolume_length + SecondEcalvolume_length + Pb_thickness3 +
                                       Polys_thickness + i * ESpacing3))) /
                  1e4;
  ...
  cout << "scint_area_for_EcalBarrel(m^2)= " << scint_area_for_EcalBarrel
       << endl;  //total scintillator area for EcalBarrel
  ...
  float SolenoidBarrelOuterCryostatInnerRadius1 =
      SolenoidBarrelConductorInnerRadius1 + SolenoidBarrelAlConductorThickness1 + SolenoidBarrelQuenchbackThickness1 +
      DipoleBarrelAlConductorThickness + SolenoidBarrelInnerCryostatThickness1 + 4.;

  float SolenoidBarrelOuterRadius1 = SolenoidBarrelOuterCryostatInnerRadius1 + SolenoidBarrelOuterAirgapThickness1 +
                                     SolenoidBarrelOuterCryostatThickness1;
  ...
  for (int i = 0; i != HcalBarrel_layers1; ++i) {
    scint_area_Hcal1 = (HcalBarrel_length *
                        (2 * 3.14159 * (HcalBarrel_rmin + Steel235_thickness1 + Polys_thickness_H + i * HSpacing1))) /
                       1e4;
  ...
  for (int i = 0; i != HcalBarrel_layers2; ++i) {
    scint_area_Hcal2 =
        (HcalBarrel_length *
         (2 * 3.14159 *
          (HcalBarrel_rmin + FirstHcalvolume_length + Steel235_thickness2 + Polys_thickness_H + i * HSpacing2))) /
        1e4;
  ...
  for (int i = 0; i != HcalBarrel_layers3; ++i) {
    scint_area_Hcal3 = (HcalBarrel_length * (2 * 3.14159 *
                                             (HcalBarrel_rmin + FirstHcalvolume_length + SecondHcalvolume_length +
                                              Steel235_thickness3 + Polys_thickness_H + i * HSpacing3))) /
                       1e4;
  ...
  cout << "scint_area_for_HcalBarrel(m^2)= " << scint_area_for_HcalBarrel
       << endl;  //total scintillator area for HcalBarrel
  ...
  cout << " -----------------total sint. area for lowE_Fhe det. (m^2) = " << sumscint
       << endl;  //total scintillator area for lowE_Fhe det.
  return 0;
}
