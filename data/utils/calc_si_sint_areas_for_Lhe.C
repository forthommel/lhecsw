...
//-------------------------------------------------------------------------------------------------
{
  ...
  cout << " -----------------number of readout channels for LHe det. = " << number_of_reaout_channel
  ...
  cout << " -----------------total sint. area for Lhe det. (m^2) = " << sumscint
       << endl;  //total scintillator area for LHe det.
  return 0;
}
