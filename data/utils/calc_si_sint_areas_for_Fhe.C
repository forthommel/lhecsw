...
//-------------------------------------------------------------------------------------------------
{
  ...
  cout << " -----------------number of readout channels for Fhe det. = " << number_of_reaout_channel
  ...
  cout << " -----------------total sint. area for Fhe det. (m^2) = " << sumscint
       << endl;  //total scintillator area for FHe det.
  return 0;
}
